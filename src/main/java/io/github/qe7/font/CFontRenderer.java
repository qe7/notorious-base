package io.github.qe7.font;

import io.github.qe7.utils.font.FontUtil;
...
public class CFontRenderer extends CFont {
    ...
    public CFontRenderer(String NameFontTTF, int size, int fonttype, boolean antiAlias, boolean fractionalMetrics) {
        super(FontUtil.getFontFromTTF(new ResourceLocation("notorious/fonts/" + NameFontTTF + ".ttf"), size, fonttype), antiAlias, fractionalMetrics);
        setupMinecraftColorcodes();
        setupBoldItalicIDs();
    }
